...
def station():
    filename = '/Users/ellisvavra/GPS-Tools/GPS_data_20200523/RDOM.NA12.tenv3'
    data_format = 'env'
    component = 'V'
    start = '20141101'
    end = '20200401'
...
def proj2LOS(gpsData, stationList, lookTable):
    ...
    # print(stationData.head()) stationData['_north(m)'] ** gpsPixel['Un'] + stationData['____up(m)'] ** gpsPixel['Uz']))
    ...
    # print(D[-5:, :]**2)
    # print()
    # print( np.dot((D[-5:, :]**2), np.ones([3,1])) )
    # print()
    # print( np.dot((D[-5:, :]**2), np.ones([3,1]))**0.5 )
    # print()
...
if __name__ == "__main__":
    # driver()
    fileRDOM = '/Users/ellisvavra/Desktop/LongValley/Data/gps/RDOM.NA12.tenv3'
    fileP649 = '/Users/ellisvavra/Desktop/LongValley/Data/gps/P649.NA12.tenv3'
    stationList = '//Users/ellisvavra/Desktop/LongValley/Data/gps/GPS-Stations-UNR.txt'
    lookTable_des =  '/Users/ellisvavra/Desktop/LongValley/Data/look_des.dat'

    RDOM_des = proj2LOS(fileRDOM, stationList, lookTable_des)
    P649_des = proj2LOS(fileP649, stationList, lookTable_des)

    dateList, difference = diffGPS(RDOM_des, P649_des, 'dates', 'LOS')
    plt.scatter(dateList, difference, s=5)
    plt.show()
